(() => {
  ...
  $(document).ready( () => {
    ...
    const openWeatherData = 'http://api.openweathermap.org/data/2.5/weather?APPID=18d1710c24bc4c6c3c198074e3a7e866&lat=34.03&lon=-118.14&units=imperial',
      myData = "weatherData/SerraMesaData.js",
      dataLocation = myData;

    $.getJSON(dataLocation, (data) => {
      console.log(JSON.stringify(data));
      let wData = new WeatherData(data);
